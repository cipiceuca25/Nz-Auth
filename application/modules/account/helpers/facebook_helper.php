...
abstract class BaseFacebook
{
    ...
    public function getLoginUrl($params = array())
    {
        ...
        return $this -> getUrl('www', 'dialog/oauth', array_merge(array('client_id' => $this -> getAppId(), 'redirect_uri' => $currentUrl,
     ...
     * getPersistentData($key) return $value. This call may be in another
     * request.
     *
     * @param string $key
     * @param array $value
 ...
 */
class Facebookk extends BaseFacebook
{
