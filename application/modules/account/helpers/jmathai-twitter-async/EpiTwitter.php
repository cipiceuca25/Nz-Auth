 ...
 *    Authenticated calls are done using OAuth and require access tokens for a
 * user.
 *    API calls which do not require authentication do not require tokens (i.e.
 * search/trends)
 *
...
class EpiTwitter extends EpiOAuth
{
    ...
    public function __call($name, $params = null/*, $username, $password*/)
    {
        ...
        // calls which do not have a consumerKey are assumed to not require
        // authentication
...
class EpiTwitterJson implements ArrayAccess, Countable, IteratorAggregate
{
    ...
    // ensure that calls complete by blocking for results, NOOP if already
    // returned
    ...
    // Implementation of the IteratorAggregate::getIterator() to support foreach
    // ($this as $...)
