<?php
    ...
    class Forgotpassword extends CI_Controller
    {
        ...
        function __construct()
        {
            ...
            $this -> load -> language(array('general', 'account/forgotpassword'));
        }
        ...
        function index()
        {
            ...
            // Store recaptcha pass in session so that users only needs to
            // complete
            // captcha once
            ...
            {
                // User has neither already passed recaptcha nor just passed
                // recaptcha
                ...
                } else
                {
                    ...
                    } else
                    {
                        ...
                        $password_reset_url = site_url('account/password?id=' . $account -> id . '&token=' . sha1($account -> id . $time . $this -> config -> item('password_reset_secret')));
            ...
            $this -> load -> view('password', isset($data) ? $data : NULL);
        }
